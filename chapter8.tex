...
As we have measured circular devices with different diameters, for stadium devices, we also have measured devices with nominal 60 nm width and length from 70 nm to 210 nm. Before we move to the mode statistics, 
...
\begin{figure}[!ht]
  ...
  \includegraphics[width=1.0\textwidth]{fig/stadium/60nmgapsummary}
   \caption{Mode gap with standard deviations versus device length for “60” width devices	The mode gap is decreasing as increasing length.}
...
\begin{figure}[!ht]
  ...
  \includegraphics[width=1.0\textwidth]{fig/stadium/4565sim}
   \caption{Example of simulation result for 45*65 $nm^2$ device.}
  \label{fig:4565sim}
\end{figure}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.8\textwidth]{fig/stadium/4565ex}
...
\centering
\begin{tabular}{ c c }
      \addheight{\includegraphics[width=75mm]{fig/stadium/4555sim}} &
      \addheight{\includegraphics[width=75mm]{fig/stadium/4575sim}} \\
      \addheight{\includegraphics[width=75mm]{fig/stadium/45105sim}} &
      \addheight{\includegraphics[width=75mm]{fig/stadium/45135sim}} \\
\end{tabular}
\caption{Stadium-shape 60 nm width Device Simulation Summary. For different sizes, Both the frequencies of the two modes and the mode spacing are plotted against the exchange constant}
\label{60nmtotalsummary}
\end{table}
